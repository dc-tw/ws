...
double calc_read_prob_bisulfite(vector_t var_list, double *matrix, int read_length, const char *seq, int seq_length, int pos, int *seqnt_map, int alt);
double calc_prob_region_bisulfite(vector_t var_list, double *matrix, int read_length, const char *seq, int seq_length, int pos, int start, int end, int *seqnt_map, int alt);
double calc_prob_bisulfite(vector_t var_list, double *matrix, int read_length, const char *seq, int seq_length, int pos, int *splice_pos, int *splice_offset, int n_splice, int *seqnt_map, int alt);
